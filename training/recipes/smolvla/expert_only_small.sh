#!/usr/bin/env bash
# SmolVLA expert-only finetune on blocktoblock_sim (8K episodes).
# Quick validation run — confirms pipeline works end-to-end.
# Target: 1 GPU, ~4GB VRAM (SmolVLA expert-only is very lightweight).
set -euo pipefail
...
DATASET_REPO="mateoguaman/language_table_blocktoblock_sim"
...
# --- Launch ---
echo "=== SmolVLA Expert-Only (small dataset validation) ==="
