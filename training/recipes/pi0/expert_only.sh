#!/usr/bin/env bash
# Pi0 expert-only finetune on blocktoblock_oracle_sim (200K episodes).
# Freezes the VLM backbone, trains only the action expert + projection layers.
...
# --- Launch ---
echo "=== Pi0 Expert-Only (oracle dataset) ==="
